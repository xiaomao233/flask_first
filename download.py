...
if flag == -1:
    ...
    print('数据库连接成功')
    mysql.export('lands', 'E:/spanned file/lands.xls')
    mysql.export('barriers', 'E:/spanned file/barriers.xls')
    mysql.export('parameters', 'E:/spanned file/parameters.xls')
    mysql.export('routes', 'E:/spanned file/routes.xls')
